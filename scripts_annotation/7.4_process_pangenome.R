...
# 0) Inputs
# -----------------
wd <- "/data/users/hfatinikun/assembly_annotation_course/annotation/GENESPACE" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "Db_1" # Your focal accession name
